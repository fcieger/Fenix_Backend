...
export class AddMissingColumnsToPedidosVenda1761958229391 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pedidos_venda" DROP CONSTRAINT "FK_a51764ea79b35ffa1e8a9cc6f75"`);
        ...
        await queryRunner.query(`ALTER TABLE "pedidos_venda" DROP COLUMN "naturezaOperacaoId"`);
        ...
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "numero" character varying`);
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "serie" character varying`);
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "orcamentoId" uuid`);
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "dataPrevisaoEntrega" date`);
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "naturezaOperacaoPadraoId" uuid`);
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "formaPagamentoId" uuid`);
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "localEstoqueId" uuid`);
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "totalGeral" numeric(14,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "observacoes" text`);
        ...
        await queryRunner.query(`ALTER TABLE "pedidos_venda" ADD "status" "public"."pedidos_venda_status_enum" NOT NULL DEFAULT 'rascunho'`);
