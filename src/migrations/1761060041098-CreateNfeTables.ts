...
export class CreateNfeTables1761060041098 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "nfe_duplicatas" DROP CONSTRAINT "FK_e74438125815ccb254639fef16c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "nfe_itens" DROP CONSTRAINT "FK_8a2cb8709d2da14e27da65c3bbd"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."nfe_destinatarioindicadorie_enum"`,
    );
