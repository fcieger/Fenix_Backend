...
export class RemoveIpiAplicarProduto1734021000001
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (table && table.findColumnByName('ipiAplicarProduto')) {
      await queryRunner.query(
        `ALTER TABLE "configuracao_imposto_estado" DROP COLUMN "ipiAplicarProduto"`,
      );
    }
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "configuracao_imposto_estado" ADD "ipiAplicarProduto" boolean NOT NULL DEFAULT false`,
    );
  }
}
